...
class TestSpecies(unittest.TestCase):
    ...
    def testPickle(self):
        ...
        self.assertEqual(self.species.getThermo().H298.value_si, species.getThermo().H298.value_si)
        self.assertEqual(self.species.getThermo().H298.units, species.getThermo().H298.units)
